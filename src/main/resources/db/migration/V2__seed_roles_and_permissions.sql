...
$$
    ...
    BEGIN
        ...
        VALUES (p1, 'product:read', NOW(), '00000000-0000-0000-0000-000000000000'),
               ...
               (p4, 'cart:read', NOW(), '00000000-0000-0000-0000-000000000000'),
               (p5, 'cart:write', NOW(), '00000000-0000-0000-0000-000000000000'),
               (p6, 'checkout:create', NOW(), '00000000-0000-0000-0000-000000000000'),
               (p7, 'payment:create', NOW(), '00000000-0000-0000-0000-000000000000'),
               (p8, 'payment:read', NOW(), '00000000-0000-0000-0000-000000000000'),
               (p9, 'address:read', NOW(), '00000000-0000-0000-0000-000000000000'),
               (p10, 'address:write', NOW(), '00000000-0000-0000-0000-000000000000'),
               (p11, 'admin:access', NOW(), '00000000-0000-0000-0000-000000000000');
